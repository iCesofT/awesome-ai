...
metadata:
  version: "1.1.0"
  domain: architecture
  triggers: architecture review, package structure, module boundaries, dependency direction, layering, clean architecture
  role: reviewer
  scope: review
---
...
- `clean-ddd-hexagonal` — The primary architecture pattern to verify during review: layer isolation, ports/adapters, dependency direction
- `ddd-strategic-design` — Verify bounded context boundaries and ubiquitous language consistency
- `architecture-adrs` — Architecture review findings that require a decision should produce an ADR
- `code-review-and-quality` — Architecture review is a macro-level complement to code-level review
- `maven-dependency-audit` — Dependency structure and module boundaries are part of architectural health
